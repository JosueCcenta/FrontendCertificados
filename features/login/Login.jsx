...
const Login = () => {
    ...
    return (
        <>
            <div className="container w-full flex flex-col justify-items-center items-center ">
                <div className=" relative w-full mt-12 lg:w-48">
                    <img src="../../img/logo/erpLogo.webp" alt="" />
                </div>
                <div className="form flex flex-col justify-items-center items-center bg-blue-900 text-white rounded-md w-80">
